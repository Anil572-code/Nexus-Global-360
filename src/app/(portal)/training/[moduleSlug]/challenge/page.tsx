...
export default async function Page({params}:{params:Promise<{moduleSlug:string}>}){ const {moduleSlug}=await params; return <TrainingAccessGate moduleSlug={moduleSlug}><InteractiveTrainingRuntime moduleSlug={moduleSlug as InteractiveModuleSlug}/></TrainingAccessGate>; }
